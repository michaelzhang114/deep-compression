# Same as summary except returns the number of params so I can calculate the compression ratio
...
def summary_return_params(net):
    ...
    return num_total_nonzero_params, num_total_params
